...
import { Activity, Bell, Bot, ChevronRight, CircleAlert, Database, FileText, FolderKanban, Gauge, Image, LayoutDashboard, ListChecks, LoaderCircle, Map as MapIcon, Menu, Search, Settings, ShieldCheck, Sparkles, Users, X } from 'lucide-react';
...
const iconMap: Record<string, LucideIcon> = {
  activity: Activity, award: Sparkles, bookopentext: FileText, bot: Bot, circledotdashed: Sparkles, database: Database,
  ...
  return <div className="admin-root">
    ...
    <main className="admin-main">
      ...
      <div className="admin-content">
        {path === '/admin/journal' ? <JournalAdminPage /> : path === '/admin/ai' ? <AdminAiControlCenterPage /> : path === '/admin/support-messages' ? <FounderSupportAdminPage /> : !isOverview ? <AdminSectionPage path={path} /> : <>
