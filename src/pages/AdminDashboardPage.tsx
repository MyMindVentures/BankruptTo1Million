...
import { AdminAiHierarchyPage } from './AdminAiHierarchyPage';
  ...
  return <div className={`admin-root ${sidebarCollapsed ? 'is-collapsed' : ''}`}>
    ...
    <main className="admin-main">
      ...
      <div className="admin-content">
        {path === '/admin/outreach' ? <OutreachAdminPage /> : path === '/admin/journal' ? <JournalAdminPage /> : path === '/admin/calendar' ? <JourneyCalendarAdminPage /> : path === '/admin/media' ? <AdminMediaVaultPage /> : path === '/admin/ai' ? <AdminAiControlCenterPage /> : path === '/admin/ai-hierarchy' ? <AdminAiHierarchyPage /> : path === '/admin/support-messages' ? <FounderSupportAdminPage /> : path === '/admin/proof-of-mind' ? <ProofOfMindAdminPage /> : !isOverview ? <AdminSectionPage path={path} /> : <>
