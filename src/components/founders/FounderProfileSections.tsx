...
export const FOUNDER_PROFILE_SECTIONS_I18N_MANIFEST = {
  componentKey: 'components.founders.founder.profile.sections',
  namespace: 'founder_profile.actions',
  translationKeys: [
    'founder_profile.actions.explore_journey',
    'founder_profile.actions.partnership',
    'founder_profile.actions.view_work',
    'founder_profile.badges.cofounder',
    'founder_profile.badges.partnerships',
    'founder_profile.badges.public',
    'founder_profile.capabilities.experience',
    'founder_profile.capabilities.expertise',
    'founder_profile.capabilities.eyebrow',
    'founder_profile.capabilities.responsibilities',
    'founder_profile.capabilities.strengths',
    'founder_profile.capabilities.title',
    'founder_profile.final_cta.connect',
    'founder_profile.final_cta.description',
    'founder_profile.final_cta.eyebrow',
    'founder_profile.final_cta.kevin_title',
    'founder_profile.final_cta.micha_title',
    'founder_profile.hero.eyebrow',
    'founder_profile.hero.portrait_alt',
    'founder_profile.location_missing',
    'founder_profile.metrics.concepts',
    'founder_profile.metrics.founder_posts',
    'founder_profile.metrics.milestones',
    'founder_profile.metrics.posts',
    'founder_profile.mission.eyebrow',
    'founder_profile.mission.title',
    'founder_profile.nav.aria',
    'founder_profile.nav.timeline',
    'founder_profile.publications.eyebrow',
    'founder_profile.publications.read_post',
    'founder_profile.publications.reading_time',
    'founder_profile.publications.title',
    'founder_profile.snapshot.based_in',
    'founder_profile.snapshot.default_focus',
    'founder_profile.snapshot.focus',
    'founder_profile.snapshot.public_since',
    'founder_profile.snapshot.public_since_value',
    'founder_profile.snapshot.role',
    'founder_profile.story.eyebrow',
    'founder_profile.story.title',
    'founder_profile.swat.context',
    'founder_profile.swat.description',
    'founder_profile.swat.evidence',
    'founder_profile.swat.eyebrow',
    'founder_profile.swat.impact',
    'founder_profile.swat.management',
    'founder_profile.swat.risk',
    'founder_profile.swat.strengths',
    'founder_profile.swat.struggles',
    'founder_profile.swat.title',
    'founder_profile.swat.usage',
    'founder_profile.switch.label',
    'founder_profile.timeline.description',
    'founder_profile.timeline.empty',
    'founder_profile.timeline.eyebrow',
    'founder_profile.timeline.hosted_by',
    'founder_profile.timeline.open_story',
    'founder_profile.timeline.title',
    'founder_profile.to_be_added',
    'founder_profile.values.eyebrow',
    'founder_profile.values.title',
    'founder_profile.work.concepts',
    'founder_profile.work.explore',
    'founder_profile.work.eyebrow',
    'founder_profile.work.founder_posts',
    'founder_profile.work.no_concepts',
    'founder_profile.work.no_founder_posts',
    'founder_profile.work.original_creator',
    'founder_profile.work.read',
    'founder_profile.work.title',
  ] as const,
  keyPatterns: [
    'founder_profile.actions.*',
    'founder_profile.badges.*',
    'founder_profile.capabilities.*',
    'founder_profile.final_cta.*',
    'founder_profile.hero.*',
    'founder_profile.metrics.*',
    'founder_profile.mission.*',
    'founder_profile.nav.*',
    'founder_profile.publications.*',
    'founder_profile.snapshot.*',
    'founder_profile.story.*',
    'founder_profile.swat.*',
    'founder_profile.switch.*',
    'founder_profile.timeline.*',
    'founder_profile.values.*',
    'founder_profile.work.*',
  ] as const,
